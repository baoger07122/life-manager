...
- 当前原生候选：`0.1.11 (12)`；最近一次云端成功构建 IPA 为 `0.1.10 (11)`。
- 对应 Web 功能基线：`v8.25.1`。
...
当前 Playgrounds 预览已进入宠物模块 V2：宠物物品两级分类、库存流水、价格历史、用户回购评价、分宠物猫咪评价、猫砂盆预测、宠物事项时间轴、宠物档案、分类设置和首页联动。该状态仍是预览中，不代表 IPA 已发布。
