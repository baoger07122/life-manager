    ...
    private var typographySection: some View {
        HomeCard {
            VStack(alignment: .leading, spacing: 12) {
                ...
                typeScaleRow("页面标题", sample: "我的物品", font: HomeTypography.pageTitle, note: "24pt / Semibold", color: HomeTheme.blue)
                typeScaleRow("分区标题", sample: "食品快捷管理", font: HomeTypography.sectionTitle, note: "19pt / Semibold", color: HomeTheme.orange)
